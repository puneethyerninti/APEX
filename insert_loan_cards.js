...
// Find Minimal Docs which is inside the Features section
let insertIndex = lines.findIndex(l => l.includes('Minimal<br />Docs</span>'));
if (insertIndex > -1) {
    // The </div> for this row is at insertIndex + 1
    // The </div> for the Features section is at insertIndex + 2
    // We insert at insertIndex + 3
    lines.splice(insertIndex + 3, 0, loanCards);
}

fs.writeFileSync('src/app/page.tsx', lines.join('\n'));
console.log('Successfully inserted loan cards');
