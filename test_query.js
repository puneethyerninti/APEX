...
const getEkoHeaders = () => {
    ...
    return {
        ...
        'Content-Type': 'application/json' // Back to JSON since 415 failed
    };
};
...
async function runProof() {
    ...
    // Put initiator_id in URL as query param
    const url = `https://api.eko.in:25002/ekoicici/v3/admin/network/agent/${USER_CODE}/service/${SERVICE_CODE}/activate?initiator_id=${EKO_INITIATOR_ID}`;
