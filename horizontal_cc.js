...
const horizontalBanner = `                                            {/* ZET Credit Card Banner */}
...
if (zetStart > -1 && zetEnd > -1) {
    lines.splice(zetStart, zetEnd - zetStart, horizontalBanner + '\n\n                                            ');
}

fs.writeFileSync('src/app/page.tsx', lines.join('\n'));
console.log('Successfully made credit card banner horizontal');
