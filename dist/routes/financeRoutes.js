...
router.post('/wallet/transfer', financeController_1.transferMoney);
router.post('/wallet/pay-merchant', financeController_1.payMerchantWithWallet);
// Passbook & Receive QR
router.get('/transactions', financeController_1.getUserTransactions);
router.get('/my-qr', financeController_1.getMyQrPayload);
