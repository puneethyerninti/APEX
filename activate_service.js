...
const url = `https://api.eko.in:25002/ekoicici/v3/admin/network/agent/${USER_CODE}/service/53/activate?initiator_id=${EKO_INITIATOR_ID}&client_ref_id=ACT_${Date.now()}`;
